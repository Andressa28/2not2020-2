 ...
 2) Essa função será chamada de dentro do bubbleSort(), recebendo o
    ...
    Ela deve retornar tue caso o primeiro parâmetro seja maior que
...
// Só os 1000 primeiros candidatos (para agilizar)

/* const candidatos1000 = candidatos.slice(0, 999)

console.time('Teste candidatos 1000')
// localCompare() faz corretamente a ordenação considerando os acentos, mas é muito mais

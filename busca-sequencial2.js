...
function comparaNome(obj, nome) {
    ...
    return obj.first_name === nome  // Usar === igual três vezes para ter mais exatidão da comparação
}

console.time('FAUSTO')
// console.log(buscaSequencial(listaNomes, 'FAUSTO', comparaNome))  // Com arrow function abaixo
...
// Exibe o objeto na posição encontrada e depois a prórpia posição
